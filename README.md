...
Ferdinand, V., Yu, A., and Marzen, S. (submitted). Humans are resource rational predictors in three sequence learning tasks.
...
The folder `Plots` contains all of the plots that are generated by the code above. They correspond to Figure 1 of the paper.
